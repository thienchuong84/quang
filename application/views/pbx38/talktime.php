		...
		$('#aExport').click(function(e){
			...
			$.ajax({
				...
				success: function(response){
					...
					// window.open("http://cipiv.com/public/files/cdr_<?php echo $this->uri->segment(1, 0); ?>.xls");
					window.open("<?php echo base_url();?>public/files/cdr_<?php echo $this->uri->segment(1, 0); ?>.xls");
				}
			});
